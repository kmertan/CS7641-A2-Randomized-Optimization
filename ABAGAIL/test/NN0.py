...
sys.path.append("C:/Documents/CS7641/CS-7641-assignment-2/ABAGAIL/ABAGAIL.jar")
...
def main():
    """Run this experiment"""
    training_ints = initialize_instances('../../data/c_trg.csv')
    testing_ints = initialize_instances('../../data/c_test.csv')
    validation_ints = initialize_instances('../../data/c_val.csv')
